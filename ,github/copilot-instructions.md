...
- **Comments:** Explain *why* a block of code is doing something, especially when parsing Home Assistant states (e.g., converting a state to a number or checking for domain availability).
...
-  All formating should be 2 space
# 8. Component Design
