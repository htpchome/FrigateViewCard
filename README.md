...
| `subtitle`                     | string  | `FrigateView`            | Secondary title text.                                                                                                                                                                     |
...
| `snapshot_update_seconds`      | number  | `60`                     | Snapshot refresh interval used by snapshot-based Preview, Grid, and Wide View Companion Camera tiles. Valid range: `10` to `240`.                                                        |
...
| `preview_page_alert_live_duration_seconds` | number | `10`           | Shared duration that alerted snapshot tiles remain live on Preview and in Wide View Companion Cameras. Valid range: `5` to `60`.                                                         |
| `hidden_tabs`                  | list    | `[snapshot]`             | Tabs to hide. Valid values: `alerts`, `clips`, `snapshot`, `recordings`, `kept`.                                                                                                          |
...
| `stream_height`                | number  | `100`                    | Maximum media/card height. Valid range: `50` to `100`.                                                                                                                                    |
| `stream_height_unit`           | string  | `%`                      | Unit for `stream_height`. Valid values: `%`, `dvh`.                                                                                                                                       |
...
| `wide_view_live_cameras`       | boolean | `false`                  | Keeps all Wide View Companion Cameras live. When disabled, tiles use refreshed snapshots and alerted tiles temporarily become live.                                                      |
| `wide_view_alert_takeover`     | boolean | `false`                  | Default state of the Wide View runtime control that allows newly alerted Companion Cameras to take over the main live view.                                                              |
