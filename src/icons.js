export const ICONS = {
  ...
  preView:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M1,1.76 A0.76,0.76 0 0 1 1.76,1 h20.48 a0.76,0.76 0 0 1 0.76,0.76 v8.98 a0.76,0.76 0 0 1 -0.76,0.76 H1.76 A0.76,0.76 0 0 1 1,10.74 Z M1,13.26 A0.76,0.76 0 0 1 1.76,12.5 h20.48 a0.76,0.76 0 0 1 0.76,0.76 v8.98 a0.76,0.76 0 0 1 -0.76,0.76 H1.76 A0.76,0.76 0 0 1 1,22.24 Z" /></svg>',
  wideView:
    '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M 1,5.52 A 0.52,0.52 0 0 1 1.52,5 h 13.83 a 0.52,0.52 0 0 1 0.52,0.52 v 9.81 a 0.52,0.52 0 0 1 -0.52,0.52 H 1.52 A 0.52,0.52 0 0 1 1,15.33 Z M 16.34,5.26 A 0.26,0.26 0 0 1 16.6,5 h 6.48 a 0.26,0.26 0 0 1 0.26,0.26 V 8.74 A 0.26,0.26 0 0 1 23.08,9 H 16.6 A 0.26,0.26 0 0 1 16.34,8.74 Z m 0,5 A 0.26,0.26 0 0 1 16.6,10 h 6.48 a 0.26,0.26 0 0 1 0.26,0.26 v 3.48 A 0.26,0.26 0 0 1 23.08,14 H 16.6 a 0.26,0.26 0 0 1 -0.26,-0.26 z m 0,5 A 0.26,0.26 0 0 1 16.6,15 h 6.48 a 0.26,0.26 0 0 1 0.26,0.26 v 3.48 A 0.26,0.26 0 0 1 23.08,19 H 16.6 a 0.26,0.26 0 0 1 -0.26,-0.26 z" /></svg>',
  mobileView:
