...
export function buildMobileCamSwitcherMarkup({
  ...
  const backButton = previewPageEnabled
    ? `<button class="round-btn preview-back-btn mobile-cam-picker__back" type="button" data-preview-back title="Back to preview page" aria-label="Back to preview page">${icons.left}</button>`
    : "";
