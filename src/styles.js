export const STYLES = `
 ...
 /* ── recordings ── */
  ...
  .live-grid-cell{position:relative;overflow:hidden;border-radius:7px;background:var(--c-bg-deep);border:var(--fvc-border-s);}
  ...
  /* ── filter + cal ── */
  .filter-panel,.cal-panel{display: none;position: absolute;right:0;background-color: #f1f1f1;min-width: 160px; width:50%;overflow: auto;box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);z-index: 3;padding:10px;}
