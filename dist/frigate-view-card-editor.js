    ...
    ${t.map(({value:o,label:n,disabled:s=!1,disabledReason:d=""})=>{const c=we(o),h=we(n),p=P(d),g=s===!0;return`<label class="theme-scope-opt card-view-start-opt" data-disabled-guidance="${p}"${g&&p?` title="${p}"`:""}>
      ...
      <div class="setting-content">
        ...
        <div class="settings-more-slot">
          ...
          ${K?`<label class="editor-swipe-choice-footer"><span>Include ${ae} Cards on Other Dashboard Pages</span><ha-switch id="ha_dashboard_swipe_include_other_cards" ${this._config?.ha_dashboard_swipe_include_other_cards?"checked":""} ${g&&H?"":"disabled"}></ha-switch></label>`:""}
          ${Se?`<label class="editor-swipe-choice-footer"><span>Swipe to Subviews</span><ha-switch data-ha-dashboard-swipe-include-subviews="${P(l)}" ${this._config?.ha_dashboard_swipe_include_subviews?"checked":""} ${g&&H?"":"disabled"}></ha-switch></label>`:""}
        </div>`}).join(""),E=[C.dashboardWide,C.insideCard].includes(p),N=new Set(re(this._config,V.desktop)),Ve=ie(this._config?.landing_page),ne=new Set(mt(this._config,V.desktop)),Oe=new Set(re(this._config,V.mobile)),ue=Pe(this._config),ve=new Set(_t(this._config)),be={[_.preview]:"Preview",[_.singleView]:"Single View",[_.mobileView]:"Mobile View",[_.wideView]:"Wide View",[_.cardView]:"Card View"},M=Ht.map(l=>{const m=l===Ve,y=!g||!N.has(l)||m;return`<label class="editor-choice-chip">
          <input class="editor-choice-chip-input" type="checkbox" name="ha_dashboard_swipe_pages" value="${P(l)}" ${ne.has(l)?"checked":""} ${m?'data-dashboard-swipe-landing="true"':""} ${y?"disabled":""}>
          <span class="editor-choice-chip-body">
            <span class="editor-choice-chip-indicator" aria-hidden="true"></span>
            <span class="editor-choice-chip-text">${L(be[l])}</span>
          </span>
        </label>`}).join(""),G=qt.map(l=>{const m=l===ue,y=!g||!Oe.has(l)||m;return`<label class="editor-choice-chip">
          <input class="editor-choice-chip-input" type="checkbox" name="ha_dashboard_swipe_mobile_pages" value="${P(l)}" ${ve.has(l)?"checked":""} ${m?'data-dashboard-swipe-landing="true"':""} ${y?"disabled":""}>
          <span class="editor-choice-chip-body">
            <span class="editor-choice-chip-indicator" aria-hidden="true"></span>
            <span class="editor-choice-chip-text">${L(be[l])}</span>
          </span>
        </label>`}).join(""),J=Ft(t),U=La(t),D=pe(this._config?.grid_order,t),Z=new Map(U.map(l=>[l.entity,l])),W=D.mode===j.custom?D.included.length:J,ze=J<ce,w=this._timezoneDisplay(),z=new Set(this._normalizeHiddenTabs(this._hiddenTabsDraft??this._config?.hidden_tabs));this._ensureThemeDraftCache();const Q=this._config?.theme==="custom"?"custom":"default",$=this._activeThemeModeKey(),xe=Bt(this._config?.theme_custom,$),si=At(this._config?.theme_custom_defaults),ni=xe.scope,li=xe.overrides,di=si[$]||{},ci=this._themeDraftCache[$]||{},ea=Ye(this._config?.stream_height),ta=Xe(this._config?.stream_height_unit),aa=wt(this._config?.col_left_width_pct),hi=yt(this._config?.wide_view_timeline_default_scale),pi=Re.includes(Number(this._config?.realtime_poll_seconds))?Number(this._config.realtime_poll_seconds):5,mi=O(this._config?.snapshot_update_seconds,Ne,Ee),_i=O(this._config?.preview_page_alert_live_duration_seconds,Fe,Math.round(Ji/1e3)),ui=O(this._config?.slideshow_alert_hold_seconds,je,Math.round(Ae/1e3)),vi=O(this._config?.slideshow_rotation_seconds,Ie,30),gi=Be.includes(Number(this._config?.grid_rotation_seconds))?Number(this._config.grid_rotation_seconds):30,Pt=(l,m)=>yo({name:l,selectedValue:m,gridEnabled:this._config?.grid_mode_enabled===!0,slideshowEnabled:this._config?.slideshow_rotation_enabled===!0}),bi=Pt("single_view_start_mode",this._config?.single_view_start_mode),fi=Pt("wide_view_start_mode",this._config?.wide_view_start_mode),wi=Pt("card_view_start_mode",this._config?.card_view_start_mode),ia=at(this._config?.card_view_view_mode),yi=[{value:Y.videoOnly,label:"Video Only"},{value:Y.bottomPanelOpen,label:"Bottom Panel Open"},{value:Y.bottomPanelClosed,label:"Bottom Panel Closed"}].map(({value:l,label:m})=>`<label class="theme-scope-opt card-view-start-opt">
          <input class="card-view-start-input" type="radio" name="card_view_view_mode" value="${l}" ${ia===l?"checked":""}>
          <span>${m}</span>
        </label>`).join(""),ra=l=>l===_.mobileView?"Mobile":l===_.preview?"Preview":l===_.wideView?"Wide View":l===_.cardView?"Card View":"Single View",xi=re(this._config,V.desktop).map(l=>({value:l,label:ra(l)})),Si=this._standaloneLandingPageRoutes().map(l=>({value:l,label:ra(l)})),Ci={[b.mobile]:"Mobile",[b.card]:"Card View",[b.previewMobile]:"Preview + Mobile",[b.previewSingle]:"Preview + Single View",[b.single]:"Single View"},ki=Rt(this._config).map(l=>({value:l,label:Ci[l]})),$e=(l,m)=>`<ha-formfield label="${m}">
          <ha-switch data-active-tab="${l}" ${z.has(l)?"":"checked"}></ha-switch>
        </ha-formfield>`,Ei=$t.map(l=>{const m=l.key,y=this._themeDefaultHex(m,$),H=me(li[m]),K=me(ci[m]),Se=H||K||y,te=di[m]===!0,He=te?y:Se,ct=!te&&He!==y;return`
        <div class="theme-custom-row" data-theme-row="${m}">
          ...
          <div class="theme-color-wrap">
            <input class="theme-color-input" type="color" data-theme-color="${m}" value="${He}" ${te?"disabled":""}>
            <button
              type="button"
        ...
        </div>`}).join(""),Ai=[{value:"light",label:"Light",icon:"mdi:white-balance-sunny"},{value:"dark",label:"Dark",icon:"mdi:weather-night"},{value:"both",label:"Both",icon:"mdi:theme-light-dark"}].map(({value:l,label:m,icon:y})=>{const H=ni===l;return`<button
          type="button"
      ...
      <div class="cam-row" draggable="true" data-row="${m}">
        ...
        <div><div class="cam-name">${L(this._cameraLabel(l))}</div><div class="cam-meta">${L(this._cameraMetaLabel(l))}</div></div>
      ...
      </div>`).join(""),Li=D.included.map((l,m)=>{const y=Z.get(l);return y?`${m%4===0?`<div class="grid-order-heading">Grid ${Math.floor(m/4)+1}</div>`:""}
          ...
          </div>`:""}).join(""),Ti=D.excluded.map(l=>{const m=Z.get(l);return m?`<div class="grid-order-excluded-row" data-grid-order-entity="${P(l)}">
          <div class="grid-order-camera-copy">
      ...
      <div class="grid-order-custom camera-group-fields" ${D.mode===j.custom?"":"hidden"}>
        <div class="grid-order-sections">
          ${Li||'<div class="cam-helper">No cameras are currently included in Grid mode.</div>'}
        </div>
        <div class="grid-order-excluded" ${D.excluded.length?"":"hidden"}>
      ...
      <div class="environment-version-summary">
        <div class="card-version-status" id="card-version-status" data-update-status="unavailable">
          <span class="environment-item-icon card-version-icon" aria-hidden="true">${T.packageCheck}</span>
          <div class="card-version-copy">
            ...
            <div class="environment-support-items">
              <div class="environment-support-item" data-home-assistant-version-notice data-support-status="unavailable" role="status" aria-live="polite" hidden>
                <span class="environment-item-icon" aria-hidden="true">${T.homeAssistant}</span>
              ...
              <div class="environment-support-item" data-frigate-integration-status data-support-status="unavailable" role="status" aria-live="polite" hidden>
                <span class="environment-item-icon" aria-hidden="true">${T.frigate}</span>
                <span data-environment-support-text></span>
              </div>
            </div>
          </div>
      ...
      <div class="section">
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start">
          <div class="editor-choice-field editor-choice-field--fit" id="realtime_poll_seconds" role="radiogroup" aria-label="Fallback Update Check">
            ...
            ${_e({name:"realtime_poll_seconds",options:ye(Re),selectedValue:pi})}
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start;margin-top:12px">
          <div id="snapshot_update_row" style="min-width:210px;display:flex;flex-direction:column;gap:6px;width:100%">
            <div class="editor-choice-field" id="snapshot_update_seconds" role="radiogroup" aria-label="Snapshot Refresh">
              ...
              ${_e({name:"snapshot_update_seconds",options:ye(Ne),selectedValue:mi})}
            </div>
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start;margin-top:12px">
          <div id="preview_alert_live_duration_row" style="min-width:210px;display:flex;flex-direction:column;gap:6px;width:100%">
            <div class="editor-choice-field" id="preview_page_alert_live_duration_seconds" role="radiogroup" aria-label="Alert Live Duration">
              ...
              ${_e({name:"preview_page_alert_live_duration_seconds",options:ye(Fe),selectedValue:_i})}
            </div>
      ...
      <div class="section">
        ...
        <div class="card-height-control">
          <div class="card-height-slider-control">
            <input name="stream_height" id="stream_height" type="range" min="${ut}" max="${vt}" step="1" value="${ea}">
            <div class="field-helper card-height-value" id="stream_height-output">${ea}${ta}</div>
          </div>
          <div class="editor-choice-field editor-choice-field--compact" id="stream_height_unit" role="radiogroup" aria-label="Card height unit">
            ${ot({name:"stream_height_unit",options:[{value:"%",label:"%"},{value:"dvh",label:"dvh"}],selectedValue:ta,compact:!0})}
          </div>
        </div>
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start">
          ...
          <div id="slideshow_rotation_row" style="display:${this._config?.slideshow_rotation_enabled?"flex":"none"};flex:1 1 100%;width:100%;flex-direction:column;gap:6px">
            <div class="editor-choice-field editor-choice-field--single-row" id="slideshow_rotation_seconds" role="radiogroup" aria-label="Camera Rotation Interval">
              ...
              ${_e({name:"slideshow_rotation_seconds",options:ye(Ie),selectedValue:vi})}
            </div>
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start;margin-top:12px">
          <div id="slideshow_alert_hold_row" style="min-width:210px;display:flex;flex-direction:column;gap:6px;width:100%">
            <div class="editor-choice-field" id="slideshow_alert_hold_seconds" role="radiogroup" aria-label="Alert Hold Duration">
              ...
              ${_e({name:"slideshow_alert_hold_seconds",options:ye(je),selectedValue:ui})}
            </div>
      ...
      </div>`,qi=O(this._config?.grid_alert_hold_seconds,We,Math.round(Me/1e3)),Ri=`
      <div class="section">
        <div class="layout-row">
      ...
      <div class="section timeline-dependent-section" id="wide-timeline-default-scale-row" style="${this._config?.wide_view_page_enabled&&this._config?.wide_view_timeline_enabled?"":"display:none"}">
        <div class="editor-choice-field" id="wide_view_timeline_default_scale" role="radiogroup" aria-label="Initial Timeline Range">
          ...
          ${_e({name:"wide_view_timeline_default_scale",options:ka.map(l=>({value:l,label:`${l} hour${l===1?"":"s"}`})),selectedValue:hi})}
        </div>
      ...
      <div class="section" id="col-width-row" style="${this._config?.wide_view_page_enabled?"":"display:none"}">
        ...
        <input id="col_left_width_pct" type="range" min="${bt}" max="${ft}" step="1" value="${aa}" style="width:100%">
        <div class="field-helper">Sets the width of Wide View's left column.</div>
        <div class="field-helper" id="col_left_width_pct-output">${aa}%</div>
      ...
      <div class="section">
        ...
        ${q?`<div class="field-helper swipe-owner-warning">${q}</div>`:""}
      </div>
      ...
      <div class="card-view-page-options" id="card-view-page-options" style="${this._config?.card_view_page_enabled?"":"display:none"}">
        ...
        <div class="card-view-video-only-options" id="card-view-video-only-options" style="${ia===Y.videoOnly?"":"display:none"}">
          <div class="section">
            <div class="layout-row">
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start">
          ...
          <div id="grid_order_row" class="grid-order-config" style="display:${this._config?.grid_mode_enabled?"flex":"none"}">
            ...
            <div class="theme-seg" role="radiogroup" aria-label="Grid order">
              <button type="button" class="theme-opt ${D.mode===j.default?"active":""}" data-grid-order-mode="default" role="radio" aria-checked="${D.mode===j.default?"true":"false"}">Default</button>
              <button type="button" class="theme-opt ${D.mode===j.custom?"active":""}" data-grid-order-mode="custom" role="radio" aria-checked="${D.mode===j.custom?"true":"false"}">Custom</button>
            </div>
          ...
          <div id="grid_rotation_row" style="display:${this._config?.grid_mode_enabled&&W>4?"flex":"none"};flex:1 1 100%;width:100%;flex-direction:column;gap:6px">
            <div class="editor-choice-field editor-choice-field--single-row" id="grid_rotation_seconds" role="radiogroup" aria-label="Grid Rotation Interval">
              ...
              ${_e({name:"grid_rotation_seconds",options:ye(Be),selectedValue:gi})}
            </div>
        ...
        <div class="layout-row" style="align-items:flex-start;gap:12px;flex-wrap:wrap;justify-content:flex-start;margin-top:12px">
          <div id="grid_alert_hold_row" style="min-width:210px;display:flex;flex-direction:column;gap:6px;width:100%">
            <div class="editor-choice-field editor-choice-field--single-row" id="grid_alert_hold_seconds" role="radiogroup" aria-label="Grid Alert Hold Duration">
              ...
              ${_e({name:"grid_alert_hold_seconds",options:ye(We),selectedValue:qi})}
            </div>
            <div class="field-helper">How long an alerted tile stays highlighted and, when needed, live.</div>
          </div>
        </div>
      </div>`,F=this._activeSettingsPanelId??null,Gi=`
      <div class="settings-container">
        ${this._renderSettingsPanel({id:"camera",title:"Camera Settings",icon:"mdi:camera",content:Di,active:F==="camera"})}
        ${this._renderSettingsPanel({id:"general",title:"General Settings",icon:"mdi:cog",content:Vi,active:F==="general"})}
        ${this._renderSettingsPanel({id:"theme",title:"Theme Settings",icon:"mdi:palette",content:Oi,active:F==="theme"})}
        ${this._renderSettingsPanel({id:"layout",title:"Layout Settings",icon:"mdi:angle-right",content:zi,active:F==="layout"})}
        ${this._renderSettingsPanel({id:"slideshow",title:"Slideshow Settings",icon:"mdi:presentation-play",content:$i,active:F==="slideshow"})}
        ${this._renderSettingsPanel({id:"gridview",title:"Grid Mode Settings",icon:"mdi:view-grid-outline",content:Fi,active:F==="gridview"})}
        ${this._renderSettingsPanel({id:"preview",title:"Preview Page",icon:"mdi:view-grid",content:Hi,active:F==="preview"})}
        ${this._renderSettingsPanel({id:"singleview",title:"Single View Page",icon:T.singleView,content:Ri,active:F==="singleview"})}
        ${this._renderSettingsPanel({id:"wideview",title:"Wide View Page",icon:"mdi:view-split-vertical",content:Ni,active:F==="wideview"})}
        ${this._renderSettingsPanel({id:"cardview",title:"Card View Page",icon:T.cardView,content:ji,active:F==="cardview"})}
        ${this._renderSettingsPanel({id:"mobileview",title:"Mobile View Page",icon:"mdi:cellphone",content:Ii,active:F==="mobileview"})}
        ${this._renderSettingsPanel({id:"swipenavigation",title:"Swipe Navigation",icon:"mdi:gesture-swipe-horizontal",content:Bi,active:F==="swipenavigation"})}
        ${this._renderSettingsPanel({id:"landing",title:"Landing Page",icon:"mdi:home-import-outline",content:Wi,active:F==="landing"})}
      ...
      <span class="config-save-reminder-icon" aria-hidden="true">${T.packageCheck}</span>
      ...
      <div id="camera-modal" class="cam-modal hidden">
        <div class="cam-modal-card camera-modal-card" role="dialog" aria-modal="true" aria-labelledby="camera-modal-title">
          <div class="cam-modal-head">
            <button type="button" id="camera-modal-close" class="round-btn" title="Close" aria-label="Close">${T.close}</button>
          ...
          <section class="camera-modal-accordion camera-modal-accordion-fixed active">
            <div class="camera-modal-accordion-bar">
              <span>Camera</span>
              <span class="camera-modal-accordion-icon" aria-hidden="true">${T.chevron}</span>
            </div>
          ...
          <div class="cam-modal-field camera-group-add-row">
            <button type="button" id="camera-modal-add-secondary" class="cam-inline-add camera-group-action">${T.cameraAdd}<span>Add second camera</span></button>
          </div>
          ...
          <div class="cam-modal-field camera-group-add-row">
            <button type="button" id="camera-modal-add-light" class="cam-inline-add camera-group-action">${T.lightAdd}<span>Add light</span></button>
          </div>
          ...
          <div class="cam-modal-field camera-group-add-row">
            <button type="button" id="camera-modal-add-light-2" class="cam-inline-add camera-group-action" hidden>${T.lightAdd}<span>Add second light</span></button>
          </div>
          ...
          <div class="cam-modal-field">
            ...
            <div id="camera-modal-ptz-rotation-row" hidden>
              <div class="editor-choice-field camera-group-layout-field" role="radiogroup" aria-label="PTZ Control Rotation">
                ...
                ${ot({name:"camera-modal-ptz-rotation",options:Va.map(l=>({value:l,label:`${l}\xB0`})),selectedValue:0,compact:!0})}
              </div>
