...
const STYLES = `
 ...
 /* \u2500\u2500 recordings \u2500\u2500 */
  ...
  /* \u2500\u2500 feed area \u2500\u2500 */
    #eng-wrap{background:var(--c-bg-deep);position:relative;width:100%;overflow:hidden;max-height:var(--view-height,none);z-index:0;isolation:isolate;transition:opacity .22s ease,border-radius .25s ease,box-shadow .25s ease;}
