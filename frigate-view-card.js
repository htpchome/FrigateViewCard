...
const STYLES = `
 ...
 /* ── recordings ── */
  ...
  .tabs{display:flex;flex-wrap: wrap;padding:0 8px;overflow-x:auto;scrollbar-width:none;position:sticky;z-index:auto;top:0;background-color:var(--c-bg-main) !important;margin:0 10px 2px;border-radius: 8px;transition: background-color 0.3s ease;}
